...
sequence_names = [sequence_name for sequence_name in sequence_names if '20211006_10' not in sequence_name and '20211006_11' not in sequence_name and os.path.isfile(os.path.join(project_dir, sequence_name, 'GND/vott-json-export/', 'RAN_'+sequence_name+'-export.json'))]
...
for i in range(N):
	val_sequence_names = sequence_names[i*fold_size:(i+1)*fold_size]
