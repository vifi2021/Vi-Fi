# run the 'zed_object_detection.py' in batch

import os
import subprocess

project_dir = '/media/hans/WINLAB-MOBILE-GROUP/RAN_Dec_data/'
# to_be_organized_dir = '2021_09_07_to_be_organized'
...
for svo_file_name, sequence_name in zip(svo_file_names, sequence_names):
	subprocess.run(['python3', 'zed_object_detection_3D.py', os.path.join(project_dir, to_be_organized_dir, svo_file_name)])